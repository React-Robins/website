  ...
  return (
    <Layout>
      ...
      <main>
        ...
        <p>
          Local organizers are the point people for any given QueerJS event, and are key to its
          success. If you would like to be a local organizer, you should be prepared to:
          <ul>
            <li> Take point on finding a venue and date to hold the event. </li>
            <li>
              {' '}
              Ensure there is adequate seating for the RSVP'd number of attendees at the selected
              venue.{' '}
            </li>
            <li>
              {' '}
              Coordinate recording of event (and individual speakers) with onsite hosts, if
              possible.{' '}
            </li>
            <li>
              {' '}
            ...
            <li>
              {' '}
              Ensure the <Link to="/code-of-conduct"> Code of Conduct</Link> is read to attendees at
              the beginning of the event.
            </li>
            <ul>
              <li>
                {' '}
                Mention <Link to="/report"> reporting mechanisms</Link> for CoC violations should
                they occur.{' '}
              </li>
            </ul>
