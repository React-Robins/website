    ...
    <Layout>
      ...
      <main>
        ...
        <Panel heading="Organizers">
          <p>
            Nothing can be organized by only one person - there is a team helping QueerJS be a safe
            space all over the world.
          </p>
          <p>
            The cities indicate what events they helped organize. Want to help organize a meetup in
            your own city? See some of the ways you can{' '}
